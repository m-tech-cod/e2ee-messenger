...
export function AuthProvider({ children }) {
  ...
  const login = async (username, password) => {
    ...
    // Stocker clés (dans notre version, le backend renvoie wrapped_private_key et public_key)
    if (data.user.wrapped_private_key) setPrivateKey(data.user.wrapped_private_key);
    if (data.user.public_key) setPublicKey(data.user.public_key);
